 ...
 */
function setup() {
    $text_domain = 'silverwp';
    $language_path = get_template_directory() . '/lang';
    // Make theme available for translation
    // Community translations can be found at https://github.com/roots/sage-translations
    if ( class_exists( 'SilverWp\Translate' ) ) {
        Translate::init( $text_domain, $language_path );
    } else {
        load_theme_textdomain( $text_domain, $language_path );
    }
  ...
  register_nav_menus(array(
    'footer_navigation' => __('Footer menu', $text_domain),
  ));
